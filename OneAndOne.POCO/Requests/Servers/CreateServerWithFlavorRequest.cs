...
{
    public class CreateServerWithFlavorRequest
    {
        ...
        /// <summary>
        /// Required: Hardware features of the server. Choose your resources using fixed_instance_size_id
        /// </summary>
        /// 
        private HardwareFlavorRequest hardware;
        [JsonProperty(PropertyName = "hardware")]
        public HardwareFlavorRequest Hardware
        {
            get { return hardware; }
            set { hardware = value; }
        }
    ...
    public class HardwareFlavorRequest
    {
        /// <summary>
